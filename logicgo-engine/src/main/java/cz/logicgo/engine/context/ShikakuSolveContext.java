...
public class ShikakuSolveContext implements GameContext {
    ...
    public ShikakuSolveContext(StepCounter stepCounter, int solutionLimit) {
        this.stepCounter = stepCounter;
        this.solutionLimit = solutionLimit;
    }

    public ShikakuSolveContext(int solutionLimit) {
        this.stepCounter = new StepCounter();
        this.solutionLimit = solutionLimit;
    }

    public ShikakuSolveContext(int solutionLimit, ConcurrentHashMap<Long, Integer> sharedCache) {
        this.stepCounter = new StepCounter();
        this.solutionLimit = solutionLimit;
    }
